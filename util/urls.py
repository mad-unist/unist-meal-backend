...
urlpatterns = [
    ...
    path("v1/process-menus-dormitory3", views.ProcessExcelMenuDormitory3.as_view(), name="v1_process_menus_dormitory3"),
    ...
    path("v1/process-menus-student2", views.ProcessExcelMenuStudent2.as_view(), name="v1_process_menus_student2"),
